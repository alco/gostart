...
No. You can change your `GOPATH` though, as described in the previous answer. But keep in mind that `$GOPATH` point to a workspace. You packages go into the _src_ directory inside a workspace.
